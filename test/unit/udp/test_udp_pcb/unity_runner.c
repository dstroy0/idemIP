...
int main(void)
{
  ...
  run_test(test_find_blocks_a_coverage_under_the_bindings_minimum, "test_find_blocks_a_coverage_under_the_bindings_minimum", 1080);
  run_test(test_find_keeps_a_partial_coverage_off_a_binding_that_is_not_lite, "test_find_keeps_a_partial_coverage_off_a_binding_that_is_not_lite", 1113);
  run_test(test_find_compares_four_octets_for_version_4, "test_find_compares_four_octets_for_version_4", 1132);
  run_test(test_find_compares_sixteen_octets_for_version_6, "test_find_compares_sixteen_octets_for_version_6", 1153);
  run_test(test_find_separates_two_zones_of_one_address, "test_find_separates_two_zones_of_one_address", 1172);
  run_test(test_find_refuses_a_version_the_binding_does_not_carry, "test_find_refuses_a_version_the_binding_does_not_carry", 1198);
  run_test(test_find_repeats, "test_find_repeats", 1217);
  run_test(test_a_find_is_a_function_of_its_borrow_alone, "test_a_find_is_a_function_of_its_borrow_alone", 1234);
  run_test(test_two_tables_do_not_share_a_port, "test_two_tables_do_not_share_a_port", 1260);
