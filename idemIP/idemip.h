 ...
 * --------------------------------------------------
 * `idemIP/core/tick.h` and `idemIP/core/dispatch.h` belong in the list below and are absent from
...
#include "idemIP/idemip_config.h" // the entry point: every count, every constant, every borrow

// --- base ----------------------------------------------------------------------------------------
#include "idemIP/checksum.h" // RFC 1071
#include "idemIP/common.h"   // the sizes and widths each standard fixes
#include "idemIP/endian.h"   // the wire-integer accessors

// --- link ----------------------------------------------------------------------------------------
#include "idemIP/ethernet/ethernet.h" // RFC 894 framing
#include "idemIP/ethernet/mii.h"      // IEEE 802.3 Clause 22 management registers
#include "idemIP/ethernet/phy.h"      // the driver contract and the claim/release frame path
#include "idemIP/ethernet/vlan.h"     // IEEE 802.1Q C-Tag
#include "idemIP/netif/dma.h"         // the descriptor rings and the pin count
#include "idemIP/netif/loopif.h"      // RFC 1122 sec 3.2.1.3, RFC 4291 sec 2.5.3
#include "idemIP/netif/netif.h"       // the interface table

// --- core ----------------------------------------------------------------------------------------
#include "idemIP/core/stats.h"    // RFC 1213 counters
#include "idemIP/core/timeouts.h" // the deadline list

// --- IPv4 ----------------------------------------------------------------------------------------
#include "idemIP/acd/acd.h"           // RFC 5227
#include "idemIP/arp/arp.h"           // RFC 826 packet format
#include "idemIP/arp/arp_table.h"     // RFC 826 translation table and pending holds
#include "idemIP/autoip/autoip.h"     // RFC 3927
#include "idemIP/dhcp/dhcp4.h"        // RFC 2131
#include "idemIP/icmp/icmp.h"         // RFC 792 message format
#include "idemIP/icmp/icmp_in.h"      // RFC 792 message path, RFC 1122 sec 3.2.2
#include "idemIP/igmp/igmp.h"         // RFC 2236
#include "idemIP/ip/ip4_addr.h"       // RFC 1122 sec 3.2.1.3 address classification
#include "idemIP/ip/ip4_forward.h"    // RFC 1812 sec 5.2.1.2
#include "idemIP/ip/ip4_frag.h"       // RFC 791 sec 3.2 fragmentation
#include "idemIP/ip/ip4_reass.h"      // RFC 791 sec 3.2, RFC 815 reassembly
#include "idemIP/ip/ip4_route.h"      // RFC 1122 sec 3.3.1
#include "idemIP/ip/ipv4.h"           // RFC 791 sec 3.1 internet header
#include "idemIP/pmtu/pmtu4.h"        // RFC 1191

// --- IPv6 ----------------------------------------------------------------------------------------
#include "idemIP/dhcp/dhcp6.h"        // RFC 8415
#include "idemIP/ethernet/ethip6.h"   // RFC 2464
#include "idemIP/icmp/icmp6_in.h"     // RFC 4443 message path
#include "idemIP/icmp/icmpv6.h"       // RFC 4443 message format
#include "idemIP/ip/ip6_addr.h"       // RFC 4291 sec 2, RFC 4007
#include "idemIP/ip/ip6_forward.h"    // RFC 8200 sec 3, RFC 4861 sec 8
#include "idemIP/ip/ip6_frag.h"       // RFC 8200 sec 4.5 fragmentation
#include "idemIP/ip/ip6_reass.h"      // RFC 8200 sec 4.5 reassembly
#include "idemIP/ip/ip6_select.h"     // RFC 6724
#include "idemIP/ip/ipv6.h"           // RFC 8200 sec 3 header
#include "idemIP/mld/mld6.h"          // RFC 2710
#include "idemIP/nd/dad.h"            // RFC 4862 sec 5.4
#include "idemIP/nd/nd6.h"            // RFC 4861 sec 5.1
#include "idemIP/nd/rdnss.h"          // RFC 8106
#include "idemIP/nd/slaac.h"          // RFC 4862 sec 5.3, sec 5.5
#include "idemIP/pmtu/pmtu6.h"        // RFC 8201

// --- transport -----------------------------------------------------------------------------------
#include "idemIP/raw/raw_pcb.h"  // RFC 1122 sec 3.4 raw bindings
#include "idemIP/tcp/tcp.h"      // RFC 9293 sec 3.1 header and sec 3.2 options
#include "idemIP/tcp/tcp_in.h"   // RFC 9293 sec 3.10.7 SEGMENT ARRIVES
#include "idemIP/tcp/tcp_isn.h"  // RFC 6528
#include "idemIP/tcp/tcp_out.h"  // RFC 9293 sec 3.7, sec 3.8
#include "idemIP/tcp/tcp_pcb.h"  // RFC 9293 sec 3.3.1 Transmission Control Blocks
#include "idemIP/udp/udp.h"      // RFC 768 header
#include "idemIP/udp/udp_pcb.h"  // RFC 768 bindings
#include "idemIP/udp/udplite.h"  // RFC 3828

// --- services ------------------------------------------------------------------------------------
#include "idemIP/dns/dns.h" // RFC 1035, RFC 5452
