...
#include "idemIP/icmp/icmpv6.h" // the RFC 4443 sec 3.2 message this reads, and through it ipv6.h
#include "idemIP/nd/nd6.h"      // the Destination Cache RFC 8201 sec 5.2 caches the estimate in
