...
/**
 * @file mii_defines.h
 * @brief The MII management register set, IEEE 802.3 Clause 22: addresses, bits and masks.
 *
 * Constants only. No entry, no table, no storage. Included by .c files that genuinely need
 * the numbers, and by no surface header.
 *
...
#ifndef IDEMIP_MII_DEFINES_H
#define IDEMIP_MII_DEFINES_H
