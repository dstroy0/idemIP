 ...
 * `Ip6Forward.entry(w)` resolves to a named function and becomes a direct call, and the table itself is
 ...
 * holds.
 */
static const Ip6ForwardNs Ip6Forward IDEMIP_UNUSED = {
    .clear = idemip_ip6_forward_clear,
    .decide = idemip_ip6_forward_decide};
IDEMIP_END_DECLS
