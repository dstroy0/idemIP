...
// Capability gates
// ---------------------------------------------------------------------------
// The five values arrive as definitions on the idemip target, one per capability, and CMake selects
// the translation units each one names. CMake refuses a set whose edges do not hold.
...
#define IDEMIP_ND6_ROUTER_ENTRY_SHIFT 5u
#endif
