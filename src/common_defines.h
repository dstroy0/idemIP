 ...
 *
 * These are the numbers the wire layouts are stated against, so the other defines headers include
 * this one. Included by .c files that genuinely need them, and by no surface header.
 */

#ifndef IDEMIP_COMMON_DEFINES_H
#define IDEMIP_COMMON_DEFINES_H
