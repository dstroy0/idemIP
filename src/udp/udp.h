 ...
 *
 * @p proto is the IP header's Protocol field, IDEMIP_UDP_PROTO for RFC 768 and
...
{
    uint32_t sum = idemip_udp_pseudo_accum(0u, src, dst, (uint16_t)len, (uint8_t)IDEMIP_UDP_PROTO);
